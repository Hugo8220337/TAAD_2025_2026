...
\subsubsection{ICNF}
O principal conjunto de dados consiste numa versão filtrada dos registos do repositório \texttt{icnf\_fire\_data} \footnote{\url{https://github.com/cityxdev/icnf_fire_data}}, que agrega ocorrências do serviço \texttt{fogos.icnf.pt}. Para este estudo foram considerados apenas os incêndios entre 2020 e 2025, após remoção de registos irrelevantes, nomeadamente:
\begin{itemize}
	\item registos com coordenadas em falta;
	\item incêndios com área ardida inferior a 0.1 hectares;
...
A partir dos dados recolhidos de cada incêndio, construiu-se um scrypt que faz chamadas à API do \textit{open-meteo} \footnote{\url{https://open-meteo.com/}} de modo a conseguir o máximo de informação meteorológica para cada dia em que cada incêndio esteve ativo.
