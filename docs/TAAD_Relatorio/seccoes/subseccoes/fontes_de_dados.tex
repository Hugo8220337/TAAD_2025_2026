...
Para cada perímetro de incêndio, foram calculadas estatísticas zonais (média e contagem de píxeis) referentes aos períodos pré e pós-incêndio. Esta abordagem permitiu avaliar a biomassa disponível antes da ignição e quantificar o impacto na vegetação após a extinção.

\subsubsection{Ocupação do Solo (CORINE)}
Para a caracterização do território, utilizou-se o inventário \textit{CORINE Land Cover} (CLC 2018). Esta fonte permitiu atribuir classes padronizadas de uso do solo aos perímetros ardidos, possibilitando a análise da suscetibilidade ao fogo em diferentes tipos de coberto (floresta, mato, zonas agrícolas ou áreas urbanas).